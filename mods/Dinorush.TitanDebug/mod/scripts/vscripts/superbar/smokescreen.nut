...
void function SmokescreenAffectsEntitiesInArea( SmokescreenStruct smokescreen, SmokescreenFXStruct fxInfo )
{
	...
	int team = TitanDebug_GetSetting( "titan_debug_ai_dodge_friendly" ) ? aiDangerTarget.GetTeam() : TEAM_INVALID
	AI_CreateDangerousArea_Static( aiDangerTarget, smokescreen.weaponOrProjectile, dangerousAreaRadius, team, true, true, fxInfo.center )
