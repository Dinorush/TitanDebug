...
function MissileThink( weapon, missile )
{
	expect entity( missile )
		...
		if ( TitanDebug_GetSetting( "titan_debug_tracker_rockets_no_orbital" ) )
			missile.SetProjectileLifetime( 7.0 )
...
void function TitanDebug_ClearTrackerOnDisembark( entity player, entity oldTitan )
{
